...
function fileName(str) {
    ...
    title = arr.join("");
    console.log(title);
    checkTitle(`cd .\\SASS\\; Test-Path .\\[0-9]*_${title}\\`);
}

fileName("Estender um conjunto de estilos CSS para outro elemento");